...
#  MATLAB_MEX_EXTENSION: binary MEX-file-name extension
#  MATLAB_MEX_EXECUTABLE: path to Matlab mex compiler
...
# $Date$
#
# Edited: Mar 04, 2015 by Daeyun Shin <daeyun@daeyunshin.com>
#   Added MATLAB_MEX_EXECUTABLE and MATLAB_MEX_EXTENSION
#
...
# Find mex executable
IF(NOT WIN32)
    FIND_PROGRAM(MATLAB_MEX_EXECUTABLE NAMES mex HINTS ${MATLAB_ROOT} PATH_SUFFIXES bin NO_DEFAULT_PATH DOC "Path to Matlab mex compiler")
ELSE()
    FIND_PROGRAM(MATLAB_MEX_EXECUTABLE NAMES mex.bat HINTS ${MATLAB_ROOT} PATH_SUFFIXES bin NO_DEFAULT_PATH DOC "Path to Matlab mex compiler")
ENDIF()
